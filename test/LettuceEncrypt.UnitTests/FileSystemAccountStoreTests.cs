...
namespace LettuceEncrypt.UnitTests
{
    ...
    {
        private DirectoryInfo _testDir = new DirectoryInfo(Path.Combine(AppContext.BaseDirectory, Path.GetRandomFileName()));
        public void Dispose()
        {
        ...
        public async Task ItStoresAsJson()
        {
            ...
            var jsonFile = new FileInfo($"{_testDir.FullName}/accounts/acme-staging-v02.api.letsencrypt.org/directory/1.json");
            Assert.True(jsonFile.Exists);
            using var readStream = jsonFile.OpenRead();
            var doc = JsonDocument.Parse(readStream);
    ...
    ""privateKey"": """"
            ...
            var jsonFile = Path.Combine(_testDir.FullName, "accounts/acme-staging-v02.api.letsencrypt.org/directory/1.json");
